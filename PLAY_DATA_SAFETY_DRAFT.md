...
6. **Public privacy-policy URL — PASS for hosting.** GitHub Pages deployed the current v72 policy at `https://dachopol.github.io/privacy-policy/`. Entering/saving that URL in Play Console remains TO VERIFY.
