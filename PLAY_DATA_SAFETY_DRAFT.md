...
6. **Public privacy-policy URL — PASS for hosting/source alignment.** The canonical policy source is aligned to v76 at `https://dachopol.github.io/privacy-policy/`. Entering/saving that URL in Play Console remains TO VERIFY.
