...
import{defaultServer,serverLocationLabel,MLAB_LOCATE_URL,parseMlabLocateResponse}from"./servers.mjs";
...
async function discoverMlabServers(){
  ...
  try{
    const response=await fetch(MLAB_LOCATE_URL,{cache:"no-store",headers:{Accept:"application/json"}});
