...
const response=await fetch(url,{redirect:"follow",headers:{"User-Agent":"ZIPSPEED-CI/73"}});
if(!response.ok)throw new Error(`Privacy URL HTTP ${response.status}`);
const html=await response.text();
for(const required of["ZIPSPEED by AnakinYoo","com.aistudio.zipspeed.zskt","73.0.0","Cloudflare"]){
