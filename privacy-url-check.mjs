...
const response=await fetch(url,{redirect:"follow",headers:{"User-Agent":"ZIPSPEED-CI/76"}});
if(!response.ok)throw new Error(`Privacy URL HTTP ${response.status}`);
const html=await response.text();
for(const required of["ZIPSPEED by AnakinYoo","com.aistudio.zipspeed.zskt","76.0.0","Cloudflare"]){
