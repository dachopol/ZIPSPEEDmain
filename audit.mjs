...
if(pkg.version!=="79.0.0"||pkg.zipspeed?.versionCode!==79)throw new Error("Version drift");
...
if(!html.includes('href="./assets/zipspeed-mark.svg?v=79"')||!brandSvg.includes("#3B82F6"))throw new Error("Web brand mark/cache revision missing");
...
console.log("AUDIT PASS — single-source ZIPSPEED v79 + native branding + loaded latency");
