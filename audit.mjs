...
if(!html.includes('href="./assets/zipspeed-mark.svg?v=80"')||!brandSvg.includes("#3B82F6"))throw new Error("Web brand mark/cache revision missing");
...
console.log("AUDIT PASS — single-source ZIPSPEED v80 + native branding + loaded latency");
