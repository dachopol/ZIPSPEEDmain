...
if(pkg.version!=="73.0.0"||pkg.zipspeed?.versionCode!==73)throw new Error("Version drift");
...
if(!html.includes('href="./assets/zipspeed-mark.svg?v=73"')||!brandSvg.includes("#3B82F6"))throw new Error("Web brand mark/cache revision missing");
...
console.log("AUDIT PASS — single-source ZIPSPEED v73 + native branding + loaded latency");
