...
if(pkg.version!=="78.0.0"||pkg.zipspeed?.versionCode!==78)throw new Error("Version drift");
...
if(!html.includes('href="./assets/zipspeed-mark.svg?v=78"')||!brandSvg.includes("#3B82F6"))throw new Error("Web brand mark/cache revision missing");
...
console.log("AUDIT PASS — single-source ZIPSPEED v78 + native branding + loaded latency");
