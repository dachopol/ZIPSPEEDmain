...
if(pkg.version!=="77.0.0"||pkg.zipspeed?.versionCode!==77)throw new Error("Version drift");
...
if(!html.includes('href="./assets/zipspeed-mark.svg?v=77"')||!brandSvg.includes("#3B82F6"))throw new Error("Web brand mark/cache revision missing");
...
console.log("AUDIT PASS — single-source ZIPSPEED v77 + native branding + loaded latency");
