import{TEST_PROFILES,CONNECTION_MODES,splitTransferBytes,calculateMbps,median,latencyJitter,probeFailPercent,parseProviderMeta,videoSuitability,isCompleteResult,speedFraction,formatMiB,mergeHistoryRecords,latestComparablePair,historyToCsv,parseBrowserConnection,comparableHistoryStats}from"./measurement.mjs";
import{networkHealthIndex,healthBand,useCaseSuitability,throughputStats,diagnosticFlags,compareResults,loadImpact,primaryDiagnostic}from"./quality.mjs";
import{defaultServer,serverLocationLabel,MLAB_LOCATE_URL,parseMlabLocateResponse,buildMlabLocateUrl}from"./servers.mjs";
...
const I18N={en:{brandSubtitle:"Real network measurement",speedEyebrow:"Speed Test",speedTitle:"Measure your connection",ready:"READY",go:"GO",stop:"STOP",hint:"Tap GO to start a measured HTTP test.",download:"Download",upload:"Upload",latency:"HTTP Latency",jitter:"Jitter",pending:"Pending",probeNote:"HTTP probe ≠ packet loss",live:"Live",throughput:"Throughput",videoEyebrow:"Video",videoTitle:"Streaming throughput threshold estimate",videoNote:"Zipspeed threshold estimate from the latest measured download only. This is not a playback test or a provider guarantee.",statusEyebrow:"Status",statusTitle:"Network context",statusNote:"Only provider metadata and verified request state are shown.",ip:"Client IP",isp:"ISP / ASN",edge:"Provider edge",area:"Client area",endpoint:"Measurement endpoint",integrity:"Result integrity",integrityValue:"HTTP 2xx + measured bytes",mapTitle:"Map-safe mode",mapNote:"No verified coordinates are available, so Zipspeed does not invent a map pin.",historyEyebrow:"History",historyTitle:"Completed tests",settingsEyebrow:"Settings",settingsTitle:"Simple by default",settingsNote:"Preferences stay on this device.",language:"Language",theme:"Theme",profile:"Test profile",methodTitle:"Measurement truth",methodText:"Throughput uses actual transferred bytes and elapsed time. Failed or incomplete tests are not saved.",speed:"Speed",video:"Video",status:"Status",history:"History",settings:"Settings",quick:"Quick",standard:"Standard",online:"Online",offline:"Offline",checking:"Checking…",reachable:"Reachable",unavailable:"Unavailable",testing:"Testing…",complete:"Complete",stopped:"Stopped",error:"Error",shared:"Share opened.",copied:"Copied result.",noResult:"No completed result yet.",historyEmpty:"No completed tests yet.",cleared:"History cleared.",light:"Light",dark:"Dark",share:"Share",export:"Export JSON",clear:"Clear",supported:"Meets Zipspeed threshold",insufficient:"Below Zipspeed threshold",unknown:"--",transferred:"transferred",sent:"sent",timeout:"Measurement timed out.",overhead:"protocol overhead",probeFail:"HTTP probe fail",themeChoice:"Light / Dark",profileChoice:"Quick / Standard",profileLocked:"Stop the active test before changing profile.",timestamp:"Timestamp",downloadError:"Download measurement failed.",uploadError:"Upload measurement failed.",latencyError:"Latency measurement failed.",genericError:"Measurement failed.",versionLabel:"Version",healthEyebrow:"Network Health",healthTitle:"Zipspeed-derived connection index",healthNote:"Calculated from measured HTTP metrics using Zipspeed model v1.1 thresholds. It is a derived product score, not a direct measurement or universal standard.",excellent:"Excellent",good:"Good",fair:"Fair",limited:"Limited",browsing:"Browsing",videoCall:"Video call",gaming:"Gaming",streaming4k:"4K streaming",suitable:"Suitable",notSuitable:"Limited",testService:"Test service",serverLocation:"Server location",notAvailable:"Not available",variation:"Download variation",variationHint:"Lower is steadier",sampleRange:"Download sample range",uploadVariation:"Upload variation",uploadVariationHint:"Lower is steadier",uploadSampleRange:"Upload sample range",uploadVariationMetric:"Upload variation",measuredFlags:"Measured flags",flagsHint:"Zipspeed thresholds",thresholdsMet:"Meets Zipspeed thresholds",variationMetric:"Variation",connectionMode:"Connection mode",singleConnection:"Single connection",multiConnection:"Multi connection (4 streams)",connectionChoice:"Single / Multi",connectionLocked:"Stop the active test before changing connection mode.",stream:"stream",streams:"streams",loadedLatency:"Download-loaded HTTP latency",loadedLatencyHint:"Probes started while download is active",uploadLoadedLatency:"Upload-loaded HTTP latency",uploadLoadedLatencyHint:"Probes started while upload requests are active",uploadLoadImpact:"Upload load delta",uploadLoadImpactHint:"Upload-loaded − idle HTTP latency",privacyEyebrow:"Privacy & Data",privacyTitle:"What this build actually does",privacyNote:"These facts are derived from the current app source and must change if the implementation changes.",privacyNetworkTitle:"Measurement traffic",privacyNetworkBody:"Speed tests contact the listed measurement provider directly. Your IP/network metadata can be visible to that provider and may be shown in Status.",privacyHistoryTitle:"Local history",privacyHistoryBody:"Completed test history is stored locally on this device. Client IP and ISP metadata are not written into Zipspeed history.",privacyPermissionsTitle:"Device permissions",privacyPermissionsBody:"This Android build requests internet/network-state access and does not request camera, microphone or device location permissions.",privacyCommerceTitle:"Ads & billing",privacyCommerceBody:"No advertising or billing SDK is present in this build. Store declarations must be updated before either is added.",exportCsv:"Export CSV",compareEyebrow:"Comparison",compareTitle:"Latest vs previous matching test",compareNeedTwo:"Needs two completed tests with the same profile and connection mode.",compareReady:"Same profile + mode",downloadChange:"Download change",uploadChange:"Upload change",latencyChange:"Latency change",ipVersion:"IP version",loadImpact:"Load latency delta",loadImpactHint:"Loaded − idle HTTP latency • Zipspeed thresholds",impactLow:"Low impact",impactModerate:"Moderate impact",impactHigh:"High impact",evidenceEyebrow:"Measurement Evidence",evidenceTitle:"Latest completed test",validatedPayload:"Validated payload",testDuration:"Test duration",measurementMode:"Measurement mode",evidenceNote:"Payload bytes are recorded only after transfer-length validation succeeds.",providerDiscoveryEyebrow:"Verified Provider Discovery",providerDiscoveryTitle:"M-Lab nearest NDT7 servers",providerDiscoveryNote:"Only contacts M-Lab Locate API after you tap Discover. This build does not run an M-Lab NDT7 measurement.",discover:"Discover",discoveryIdle:"Not requested",discoveryChecking:"Discovering…",discoveryUnavailable:"Discovery unavailable",discoveryFound:"servers found",ndt7Ready:"NDT7 endpoint advertised",privacyDiscoveryTitle:"Optional M-Lab discovery",privacyDiscoveryBody:"Only when you tap Discover, Zipspeed contacts the M-Lab Locate API to list NDT7 servers. If you enter a country code, that code is sent as a Locate query parameter. This build does not run an M-Lab measurement.",countryCode:"Country code",countryHint:"Optional ISO 3166-1 alpha-2. Blank = nearest.",countryInvalid:"Use a 2-letter ISO country code.",discoveryTarget:"Target",browserNetworkEyebrow:"Browser Network Hint",browserNetworkTitle:"Connection context from this browser",browserNetworkNote:"Browser-provided estimates only. These values are not Zipspeed test results and may be unavailable.",browserType:"Connection type",browserEffective:"Effective type",browserDownlink:"Browser downlink estimate",browserRtt:"Browser RTT estimate",browserSaveData:"Data saver",enabled:"On",disabled:"Off",privacyBrowserTitle:"Browser network hint",privacyBrowserBody:"When available, browser connection estimates are displayed locally. Zipspeed does not save these hints in History or send them to a new destination.",consistencyEyebrow:"Comparable History",consistencyTitle:"Recent matching test statistics",consistencyNote:"Local completed tests only. Same profile and connection mode. Not continuous monitoring.",matchingTests:"Matching tests",medianDownload:"Median download",medianUpload:"Median upload",medianLatency:"Median latency",downloadSpread:"Download spread"},th:{brandSubtitle:"วัดเครือข่ายจากข้อมูลจริง",speedEyebrow:"ทดสอบความเร็ว",speedTitle:"วัดการเชื่อมต่อของคุณ",ready:"พร้อม",go:"GO",stop:"หยุด",hint:"แตะ GO เพื่อเริ่มการทดสอบ HTTP ที่วัดจริง",download:"ดาวน์โหลด",upload:"อัปโหลด",latency:"เวลาแฝง HTTP",jitter:"จิตเตอร์",pending:"รอผล",probeNote:"HTTP probe ไม่ใช่ packet loss",live:"สด",throughput:"ความเร็วแบบเรียลไทม์",videoEyebrow:"วิดีโอ",videoTitle:"ค่าประเมินเกณฑ์ความเร็วสำหรับสตรีม",videoNote:"เป็นค่าประเมินตามเกณฑ์ Zipspeed จากความเร็วดาวน์โหลดที่วัดล่าสุดเท่านั้น ไม่ใช่การเล่นวิดีโอจริงหรือการรับประกันจากผู้ให้บริการ",statusEyebrow:"สถานะ",statusTitle:"บริบทเครือข่าย",statusNote:"แสดงเฉพาะเมทาดาทาจากผู้ให้บริการและสถานะคำขอที่ตรวจได้จริง",ip:"IP ผู้ใช้",isp:"ISP / ASN",edge:"Provider edge",area:"พื้นที่ผู้ใช้",endpoint:"ปลายทางทดสอบ",integrity:"ความถูกต้องของผล",integrityValue:"HTTP 2xx + ไบต์ที่วัดจริง",mapTitle:"โหมดแผนที่ปลอดการเดา",mapNote:"ไม่มีพิกัดที่ยืนยันได้ จึงไม่สร้างหมุดแผนที่ขึ้นเอง",historyEyebrow:"ประวัติ",historyTitle:"ผลที่ทดสอบสำเร็จ",settingsEyebrow:"ตั้งค่า",settingsTitle:"เรียบง่ายเป็นค่าเริ่มต้น",settingsNote:"การตั้งค่าเก็บบนเครื่องนี้",language:"ภาษา",theme:"ธีม",profile:"รูปแบบทดสอบ",methodTitle:"หลักการวัด",methodText:"ความเร็วคำนวณจากไบต์ที่รับส่งจริงและเวลาจริง ผลที่ล้มเหลวหรือไม่ครบจะไม่ถูกบันทึก",speed:"สปีด",video:"วิดีโอ",status:"สถานะ",history:"ประวัติ",settings:"ตั้งค่า",quick:"แบบเร็ว",standard:"มาตรฐาน",online:"ออนไลน์",offline:"ออฟไลน์",checking:"กำลังตรวจ…",reachable:"เชื่อมต่อได้",unavailable:"ใช้งานไม่ได้",testing:"กำลังทดสอบ…",complete:"เสร็จสิ้น",stopped:"หยุดแล้ว",error:"ผิดพลาด",shared:"เปิดหน้าต่างแชร์แล้ว",copied:"คัดลอกผลแล้ว",noResult:"ยังไม่มีผลทดสอบที่สมบูรณ์",historyEmpty:"ยังไม่มีผลทดสอบที่สมบูรณ์",cleared:"ล้างประวัติแล้ว",light:"สว่าง",dark:"มืด",share:"แชร์",export:"ส่งออก JSON",clear:"ล้าง",supported:"ผ่านเกณฑ์ Zipspeed",insufficient:"ต่ำกว่าเกณฑ์ Zipspeed",unknown:"--",transferred:"รับแล้ว",sent:"ส่งแล้ว",timeout:"หมดเวลาการวัด",overhead:"ส่วนเกินโปรโตคอล",probeFail:"HTTP probe ล้มเหลว",themeChoice:"สว่าง / มืด",profileChoice:"แบบเร็ว / มาตรฐาน",profileLocked:"หยุดการทดสอบก่อนเปลี่ยนรูปแบบ",timestamp:"เวลา",downloadError:"วัดดาวน์โหลดไม่สำเร็จ",uploadError:"วัดอัปโหลดไม่สำเร็จ",latencyError:"วัดเวลาแฝงไม่สำเร็จ",genericError:"การวัดไม่สำเร็จ",versionLabel:"เวอร์ชัน",healthEyebrow:"สุขภาพเครือข่าย",healthTitle:"ดัชนีอนุมานตามเกณฑ์ Zipspeed",healthNote:"คำนวณจากค่าที่วัดจริงด้วยโมเดลเกณฑ์ Zipspeed v1.1 เป็นคะแนนอนุมานของผลิตภัณฑ์ ไม่ใช่ค่าที่วัดโดยตรงหรือมาตรฐานสากล",excellent:"ยอดเยี่ยม",good:"ดี",fair:"พอใช้",limited:"จำกัด",browsing:"ท่องเว็บ",videoCall:"วิดีโอคอล",gaming:"เกม",streaming4k:"สตรีม 4K",suitable:"เหมาะสม",notSuitable:"จำกัด",testService:"บริการทดสอบ",serverLocation:"ตำแหน่งเซิร์ฟเวอร์",notAvailable:"ไม่มีข้อมูล",variation:"ความแกว่งขาดาวน์โหลด",variationHint:"ยิ่งต่ำยิ่งคงที่",sampleRange:"ช่วงตัวอย่างดาวน์โหลด",uploadVariation:"ความแกว่งขาอัปโหลด",uploadVariationHint:"ยิ่งต่ำยิ่งคงที่",uploadSampleRange:"ช่วงตัวอย่างอัปโหลด",uploadVariationMetric:"ความแกว่งอัปโหลด",measuredFlags:"ธงวัดผล",flagsHint:"เกณฑ์ของ Zipspeed",thresholdsMet:"ผ่านเกณฑ์ Zipspeed",variationMetric:"ความแกว่ง",connectionMode:"โหมดการเชื่อมต่อ",singleConnection:"การเชื่อมต่อเดี่ยว",multiConnection:"หลายการเชื่อมต่อ (4 สตรีม)",connectionChoice:"เดี่ยว / หลาย",connectionLocked:"หยุดการทดสอบก่อนเปลี่ยนโหมดการเชื่อมต่อ",stream:"สตรีม",streams:"สตรีม",loadedLatency:"เวลาแฝง HTTP ขณะดาวน์โหลด",loadedLatencyHint:"เริ่ม probe ระหว่างที่ดาวน์โหลดกำลังทำงาน",uploadLoadedLatency:"เวลาแฝง HTTP ขณะอัปโหลด",uploadLoadedLatencyHint:"เริ่ม probe ขณะที่คำขออัปโหลดยังทำงาน",uploadLoadImpact:"ผลต่างเวลาแฝงขณะอัปโหลด",uploadLoadImpactHint:"เวลาแฝงขณะอัปโหลด − เวลาแฝงปกติ",privacyEyebrow:"ความเป็นส่วนตัวและข้อมูล",privacyTitle:"สิ่งที่ build นี้ทำจริง",privacyNote:"ข้อมูลนี้อ้างอิงจาก source ปัจจุบันและต้องอัปเดตเมื่อ implementation เปลี่ยน",privacyNetworkTitle:"ทราฟฟิกการวัด",privacyNetworkBody:"การทดสอบติดต่อผู้ให้บริการวัดที่ระบุโดยตรง ผู้ให้บริการอาจเห็น IP/ข้อมูลเครือข่ายและ Zipspeed อาจแสดงข้อมูลนั้นในหน้าสถานะ",privacyHistoryTitle:"ประวัติบนเครื่อง",privacyHistoryBody:"ผลทดสอบที่สำเร็จถูกเก็บไว้บนอุปกรณ์นี้ โดย Zipspeed ไม่เขียน IP ผู้ใช้หรือข้อมูล ISP ลงในประวัติ",privacyPermissionsTitle:"สิทธิ์อุปกรณ์",privacyPermissionsBody:"Android build นี้ขอสิทธิ์อินเทอร์เน็ต/สถานะเครือข่าย และไม่ขอสิทธิ์กล้อง ไมโครโฟน หรือตำแหน่งอุปกรณ์",privacyCommerceTitle:"โฆษณาและการชำระเงิน",privacyCommerceBody:"build นี้ยังไม่มี SDK โฆษณาหรือระบบชำระเงิน ต้องอัปเดตคำประกาศ Store ก่อนเพิ่มระบบดังกล่าว",exportCsv:"ส่งออก CSV",compareEyebrow:"เปรียบเทียบ",compareTitle:"ผลล่าสุดเทียบครั้งก่อนที่เงื่อนไขตรงกัน",compareNeedTwo:"ต้องมีผลสำเร็จอย่างน้อย 2 ครั้งที่ใช้โปรไฟล์และโหมดการเชื่อมต่อเดียวกัน",compareReady:"โปรไฟล์ + โหมดตรงกัน",downloadChange:"ดาวน์โหลดเปลี่ยน",uploadChange:"อัปโหลดเปลี่ยน",latencyChange:"เวลาแฝงเปลี่ยน",ipVersion:"เวอร์ชัน IP",loadImpact:"ผลกระทบเวลาแฝงเมื่อมีโหลด",loadImpactHint:"เวลาแฝงขณะโหลด − เวลาแฝงปกติ • เกณฑ์ Zipspeed",impactLow:"ผลกระทบต่ำ",impactModerate:"ผลกระทบปานกลาง",impactHigh:"ผลกระทบสูง",evidenceEyebrow:"หลักฐานการวัด",evidenceTitle:"ผลสำเร็จล่าสุด",validatedPayload:"เพย์โหลดที่ตรวจยืนยันแล้ว",testDuration:"ระยะเวลาทดสอบ",measurementMode:"โหมดการวัด",evidenceNote:"บันทึกจำนวนไบต์หลังตรวจยืนยันความยาวการรับส่งสำเร็จเท่านั้น",providerDiscoveryEyebrow:"ค้นหาผู้ให้บริการที่ยืนยันได้",providerDiscoveryTitle:"เซิร์ฟเวอร์ M-Lab NDT7 ใกล้คุณ",providerDiscoveryNote:"จะติดต่อ M-Lab Locate API หลังคุณกดค้นหาเท่านั้น build นี้ยังไม่รันการวัด M-Lab NDT7",discover:"ค้นหา",discoveryIdle:"ยังไม่ได้ร้องขอ",discoveryChecking:"กำลังค้นหา…",discoveryUnavailable:"ค้นหาไม่ได้",discoveryFound:"เซิร์ฟเวอร์ที่พบ",ndt7Ready:"มี NDT7 endpoint",privacyDiscoveryTitle:"การค้นหา M-Lab แบบเลือกใช้",privacyDiscoveryBody:"เมื่อคุณกดค้นหาเท่านั้น Zipspeed จะติดต่อ M-Lab Locate API เพื่อแสดงเซิร์ฟเวอร์ NDT7 หากกรอกรหัสประเทศ รหัสดังกล่าวจะถูกส่งเป็นพารามิเตอร์ Locate build นี้ยังไม่รันการวัด M-Lab",countryCode:"รหัสประเทศ",countryHint:"ISO 3166-1 alpha-2 แบบ 2 ตัวอักษร เว้นว่าง = ใกล้ที่สุด",countryInvalid:"กรอกรหัสประเทศ ISO 2 ตัวอักษร",discoveryTarget:"เป้าหมาย",browserNetworkEyebrow:"ข้อมูลเครือข่ายจากเบราว์เซอร์",browserNetworkTitle:"บริบทการเชื่อมต่อจากเบราว์เซอร์นี้",browserNetworkNote:"เป็นค่าประมาณจากเบราว์เซอร์ ไม่ใช่ผลทดสอบ Zipspeed และบางอุปกรณ์อาจไม่มีข้อมูล",browserType:"ประเภทการเชื่อมต่อ",browserEffective:"ประเภทเครือข่ายโดยประมาณ",browserDownlink:"ดาวน์โหลดโดยประมาณจากเบราว์เซอร์",browserRtt:"RTT โดยประมาณจากเบราว์เซอร์",browserSaveData:"โหมดประหยัดข้อมูล",enabled:"เปิด",disabled:"ปิด",privacyBrowserTitle:"ข้อมูลเครือข่ายจากเบราว์เซอร์",privacyBrowserBody:"เมื่อเบราว์เซอร์มีข้อมูล Zipspeed จะแสดงค่าประมาณบนเครื่องเท่านั้น ไม่บันทึกข้อมูลนี้ใน History และไม่ส่งไปยังปลายทางใหม่",consistencyEyebrow:"ประวัติที่เทียบกันได้",consistencyTitle:"สถิติจากผลล่าสุดที่เงื่อนไขตรงกัน",consistencyNote:"ใช้เฉพาะผลสำเร็จบนเครื่องที่โปรไฟล์และโหมดการเชื่อมต่อตรงกัน ไม่ใช่การมอนิเตอร์ต่อเนื่อง",matchingTests:"จำนวนผลที่ตรงกัน",medianDownload:"มัธยฐานดาวน์โหลด",medianUpload:"มัธยฐานอัปโหลด",medianLatency:"มัธยฐานเวลาแฝง",downloadSpread:"ช่วงกระจายดาวน์โหลด"}};
...
async function measureLoadedHttpLatency(id,probeIndex,phase="download"){
  const scope=linkedController(8000),started=performance.now();
  try{
    const response=await fetch(`${ENDPOINT}/__down?bytes=1&ts=${Date.now()}-${phase}-loaded-${id}-${probeIndex}`,{cache:"no-store",signal:scope.signal});
    ensureRun(id);
...
function measureUpload(id){
  ...
  return new Promise((resolve,reject)=>{
    const sentByStream=new Array(chunks.length).fill(0),started=performance.now(),loadedProbePromises=[],probeTimers=[],uploadSamples=[];
    let completed=0,settled=false,finishing=false,lastSampleAt=started,lastSampleBytes=0;
    const totalSent=()=>sentByStream.reduce((sum,value)=>sum+value,0);
    const cleanup=xhr=>currentXhrs.delete(xhr);
    const clearProbeTimers=()=>{for(const timer of probeTimers)clearTimeout(timer)};
    const fail=error=>{
      if(settled)return;
      settled=true;finishing=false;
      clearProbeTimers();
      abortCurrentUploads();
      reject(error);
    };
    const finish=async()=>{
      if(settled||finishing||completed!==chunks.length)return;
      finishing=true;
      clearProbeTimers();
      try{
        ensureRun(id);
        ...
        if(sent>lastSampleBytes&&finishedAt>lastSampleAt){const finalSample=calculateMbps(sent-lastSampleBytes,finishedAt-lastSampleAt);if(finalSample!==null&&finalSample>0)uploadSamples.push(finalSample)}
        const durationMs=finishedAt-started,mbps=calculateMbps(sent,durationMs);
        if(mbps===null||mbps<=0)throw new Error("Upload unavailable");
        const probeResults=await Promise.allSettled(loadedProbePromises);
        ensureRun(id);
        const loadedSamples=probeResults.filter(item=>item.status==="fulfilled"&&Number.isFinite(item.value)&&item.value>=0).map(item=>item.value);
        settled=true;finishing=false;
        ui.up.textContent=mbps.toFixed(1);ui.upState.textContent="";setGauge(mbps);setProgress(95);
        resolve({mbps,sentBytes:sent,durationMs,stats:throughputStats(uploadSamples),loadedLatencyMs:loadedSamples.length?median(loadedSamples):null,loadedLatencySampleCount:loadedSamples.length});
    ...
    chunks.forEach((bytes,index)=>{
      ...
      xhr.upload.onprogress=event=>{
        ...
        const now=performance.now(),sent=totalSent(),mbps=calculateMbps(sent,now-started);
        if(sent>lastSampleBytes&&now>lastSampleAt){const intervalMbps=calculateMbps(sent-lastSampleBytes,now-lastSampleAt);if(intervalMbps!==null&&intervalMbps>0){uploadSamples.push(intervalMbps);if(uploadSamples.length>80)uploadSamples.shift()}lastSampleBytes=sent;lastSampleAt=now}
...
function renderHealth(result=lastResult){
  ...
  const uploadVariation=Number(result?.uploadThroughputVariationPct),uploadMin=Number(result?.uploadThroughputMinMbps),uploadMax=Number(result?.uploadThroughputMaxMbps);
  $("uploadVariationValue").textContent=Number.isFinite(uploadVariation)?`${uploadVariation.toFixed(1)}%`:"--";
  $("uploadRangeValue").textContent=Number.isFinite(uploadMin)&&Number.isFinite(uploadMax)?`${uploadMin.toFixed(1)}–${uploadMax.toFixed(1)}`:"--";
  const flags=diagnosticFlags(result);
  $("flagsValue").textContent=result?String(flags.length):"--";
  const concern=primaryDiagnostic(result),concernEl=$("diagnosticConcernValue");
  if(!result)concernEl.textContent="--";
  else if(!concern)concernEl.textContent=t("diagnosticConcernNone");
  else{
    const labelKey=concern.id==="variation"?"variation":concern.id==="uploadVariation"?"uploadVariation":concern.id==="loadImpact"?"loadImpact":concern.id==="uploadLoadImpact"?"uploadLoadImpact":concern.id;
    const operator=concern.direction==="below"?"<":">";
    concernEl.textContent=`${t(labelKey)} ${concern.value.toFixed(1)} ${concern.unit} ${operator} ${concern.threshold} ${concern.unit}`;
  }
  const loadedLatency=Number(result?.loadedLatencyMs);$("loadedLatencyValue").textContent=Number.isFinite(loadedLatency)?`${loadedLatency.toFixed(1)} ms`:"--";const impact=loadImpact(result?.latencyMs,result?.loadedLatencyMs),impactEl=$("loadImpactValue");impactEl.textContent=impact?`${impact.deltaMs>=0?"+":""}${impact.deltaMs.toFixed(1)} ms • ${t(impact.band==="low"?"impactLow":impact.band==="moderate"?"impactModerate":"impactHigh")}`:"--";const uploadLoaded=Number(result?.uploadLoadedLatencyMs);$("uploadLoadedLatencyValue").textContent=Number.isFinite(uploadLoaded)?`${uploadLoaded.toFixed(1)} ms`:"--";const uploadImpact=loadImpact(result?.latencyMs,result?.uploadLoadedLatencyMs),uploadImpactEl=$("uploadLoadImpactValue");uploadImpactEl.textContent=uploadImpact?`${uploadImpact.deltaMs>=0?"+":""}${uploadImpact.deltaMs.toFixed(1)} ms • ${t(uploadImpact.band==="low"?"impactLow":uploadImpact.band==="moderate"?"impactModerate":"impactHigh")}`:"--";impactEl.className=impact?.band||"";
}
function browserConnectionObject(){return navigator.connection||navigator.mozConnection||navigator.webkitConnection||null}
function renderBrowserNetworkInfo(){
  const info=parseBrowserConnection(browserConnectionObject());
  $("browserTypeValue").textContent=info?.type||"--";
  $("browserEffectiveValue").textContent=info?.effectiveType||"--";
  $("browserDownlinkValue").textContent=Number.isFinite(info?.downlinkMbps)?`${info.downlinkMbps.toFixed(1)} Mbps`:"--";
  $("browserRttValue").textContent=Number.isFinite(info?.rttMs)?`${info.rttMs.toFixed(0)} ms`:"--";
  $("browserSaveDataValue").textContent=typeof info?.saveData==="boolean"?t(info.saveData?"enabled":"disabled"):"--";
}
const browserConnection=browserConnectionObject();
browserConnection?.addEventListener?.("change",renderBrowserNetworkInfo);
function renderMlabDiscovery(){
  const list=$("mlabDiscoveryList"),state=$("mlabDiscoveryState"),button=$("mlabDiscoverButton");
  if(!list||!state||!button)return;
  button.textContent=t("discover");
  const country=$("mlabCountryInput");if(country)country.value=country.value.toUpperCase();
  list.innerHTML="";
  if(!mlabDiscoveryResults.length){
    if(!state.dataset.state||state.dataset.state==="idle")state.textContent=t("discoveryIdle");
    return;
  }
  state.dataset.state="ready";
  state.textContent=`${mlabDiscoveryResults.length} ${t("discoveryFound")}`;
  for(const item of mlabDiscoveryResults){
    const row=document.createElement("article");row.className="provider-server-row";
    const main=document.createElement("div"),name=document.createElement("strong"),location=document.createElement("span"),capability=document.createElement("small");
    name.textContent=item.machine;
    location.textContent=[item.city,item.country].filter(Boolean).join(" • ")||"--";
    capability.textContent=item.downloadAvailable&&item.uploadAvailable?t("ndt7Ready"):"NDT7";
    main.append(name,location);row.append(main,capability);list.appendChild(row);
  }
}
async function discoverMlabServers(){
  const button=$("mlabDiscoverButton"),state=$("mlabDiscoveryState");
  if(!button||!state)return;
  button.disabled=true;state.dataset.state="loading";state.textContent=t("discoveryChecking");
  try{
    const countryInput=$("mlabCountryInput"),country=countryInput?.value||"",discoveryUrl=buildMlabLocateUrl(country);
    if(!discoveryUrl){state.dataset.state="error";state.textContent=t("countryInvalid");countryInput?.focus();return}
    const response=await fetch(discoveryUrl,{cache:"no-store",headers:{Accept:"application/json"}});
    if(!response.ok)throw new Error(`M-Lab Locate HTTP ${response.status}`);
    mlabDiscoveryResults=parseMlabLocateResponse(await response.json());
    if(!mlabDiscoveryResults.length)throw new Error("No M-Lab servers returned");
    renderMlabDiscovery();
  }catch{
    mlabDiscoveryResults=[];state.dataset.state="error";state.textContent=t("discoveryUnavailable");$("mlabDiscoveryList").innerHTML="";
  }finally{button.disabled=false;button.textContent=t("discover")}
}
$("mlabDiscoverButton")?.addEventListener("click",discoverMlabServers);
$("mlabCountryInput")?.addEventListener("input",event=>{event.target.value=event.target.value.toUpperCase().replace(/[^A-Z]/g,"").slice(0,2)});
...
function renderHistoryConsistency(){
  const stats=comparableHistoryStats(history,5);
  $("consistencyContext").textContent=stats?`${t(stats.profile)} • ${t(stats.connectionMode==="multi"?"multiConnection":"singleConnection")}`:"--";
  $("consistencyCountValue").textContent=stats?String(stats.sampleCount):"--";
  $("consistencyDownValue").textContent=stats?`${stats.medianDownloadMbps.toFixed(1)} Mbps`:"--";
  $("consistencyUpValue").textContent=stats?`${stats.medianUploadMbps.toFixed(1)} Mbps`:"--";
  $("consistencyLatencyValue").textContent=stats?`${stats.medianLatencyMs.toFixed(1)} ms`:"--";
  $("consistencySpreadValue").textContent=stats?`${stats.downloadSpreadMbps.toFixed(1)} Mbps`:"--";
}
...
function renderHistory(){const list=$("historyList"),empty=$("historyEmpty");list.innerHTML="";empty.textContent=t("historyEmpty");empty.hidden=history.length>0;renderMeasurementEvidence();renderHistoryConsistency();renderHistoryComparison();[...history].reverse().forEach(r=>{const item=document.createElement("article");item.className="history-item";item.innerHTML=`<div class="history-main"><strong>↓ ${r.downloadMbps.toFixed(1)} / ↑ ${r.uploadMbps.toFixed(1)} Mbps</strong><span>${new Date(r.timestamp).toLocaleString(lang==="th"?"th-TH":"en-US")} • ${t(r.profile||"standard")} • ${t((r.connectionMode||"single")==="multi"?"multiConnection":"singleConnection")}</span></div><div class="history-meta">${r.latencyMs.toFixed(1)} ms<br>${r.edge||"--"}</div>`;list.appendChild(item)})}
function resultText(r){return isCompleteResult(r)?`Zipspeed\n${t("download")}: ${r.downloadMbps.toFixed(1)} Mbps\n${t("upload")}: ${r.uploadMbps.toFixed(1)} Mbps\n${t("latency")}: ${r.latencyMs.toFixed(1)} ms\n${t("jitter")}: ${r.jitterMs.toFixed(1)} ms\n${t("probeFail")}: ${r.probeFailPct.toFixed(1)}%\n${Number.isFinite(r.loadedLatencyMs)?`${t("loadedLatency")}: ${r.loadedLatencyMs.toFixed(1)} ms\n`:""}${Number.isFinite(r.loadedLatencyDeltaMs)?`${t("loadImpact")}: ${r.loadedLatencyDeltaMs>=0?"+":""}${r.loadedLatencyDeltaMs.toFixed(1)} ms\n`:""}${Number.isFinite(r.uploadLoadedLatencyMs)?`${t("uploadLoadedLatency")}: ${r.uploadLoadedLatencyMs.toFixed(1)} ms\n`:""}${Number.isFinite(r.uploadLoadedLatencyDeltaMs)?`${t("uploadLoadImpact")}: ${r.uploadLoadedLatencyDeltaMs>=0?"+":""}${r.uploadLoadedLatencyDeltaMs.toFixed(1)} ms\n`:""}${Number.isFinite(r.throughputVariationPct)?`${t("variationMetric")}: ${r.throughputVariationPct.toFixed(1)}%\n`:""}${Number.isFinite(r.uploadThroughputVariationPct)?`${t("uploadVariationMetric")}: ${r.uploadThroughputVariationPct.toFixed(1)}%\n`:""}${t("edge")}: ${r.edge||"--"}\n${t("profile")}: ${t(r.profile||"standard")}\n${t("connectionMode")}: ${t((r.connectionMode||"single")==="multi"?"multiConnection":"singleConnection")}\n${r.endpointId?`Endpoint: ${r.endpointId}\n`:""}${Number.isFinite(r.testDurationMs)?`${t("testDuration")}: ${(r.testDurationMs/1000).toFixed(2)} s\n`:""}${t("timestamp")}: ${r.timestamp}`:null}
...
applyServerInfo();renderHealth();renderBrowserNetworkInfo();renderMlabDiscovery();loadAppVersion();
