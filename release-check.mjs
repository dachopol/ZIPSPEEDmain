...
const evidence={generatedAt:new Date().toISOString(),packageId:pkg.zipspeed.packageId,version:pkg.version,versionCode:pkg.zipspeed.versionCode,permissions,adsSdkDetected:false,billingSdkDetected:false,historyStorage:"localStorage",providerMetadataSavedToHistory:false,storeReview:{inAppPrivacyPolicy:"PASS",privacyPolicyPublicUrl:"TO VERIFY",dataSafety:"TO VERIFY",signedUploadableAab:"UNVERIFIED",playUpload:"UNVERIFIED",physicalAndroidRuntime:"UNVERIFIED"}};
